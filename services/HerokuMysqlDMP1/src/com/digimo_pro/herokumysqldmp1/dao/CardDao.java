...
/**
 * Specifies methods used to obtain and modify Card related information
 * which is stored in the database.
 */
@Repository("HerokuMysqlDMP1.CardDao")
public class CardDao extends WMGenericDaoImpl<Card, Integer> {
