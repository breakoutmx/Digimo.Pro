...
/**
 * Specifies methods used to obtain and modify Profile related information
 * which is stored in the database.
 */
@Repository("HerokuMysqlDMP1.ProfileDao")
public class ProfileDao extends WMGenericDaoImpl<Profile, Integer> {
