...
import com.digimo_pro.herokumysqldmp1.service.CustomerService;
 ...
 * @see Customer
 */
@RestController("HerokuMysqlDMP1.CustomerController")
@Api(value = "CustomerController", description = "Exposes APIs to work with Customer resource.")
@RequestMapping("/HerokuMysqlDMP1/Customer")
public class CustomerController {
    ...
    public Page<Card> findAssociatedCards(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return customerService.findAssociatedCards(id, pageable);
    }
